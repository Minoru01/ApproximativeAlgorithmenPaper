...
Jedes Element des Streams wird dann mit den Hash-Funktionen gehasht 
und in die der Hash-Funktion zugeteilte Zeile eingetragen. 
Wird ein Hash-Wert in einer Zeile mehrfach hinzugefügt, 
erhöht sich dann ein Counter für diesen Hash-Wert. 
